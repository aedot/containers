...
![GitHub Repo stars](https://img.shields.io/github/stars/aedot/containers?style=for-the-badge)
![GitHub forks](https://img.shields.io/github/forks/aedot/containers?style=for-the-badge)
![GitHub Workflow Status (with event)](https://img.shields.io/github/actions/workflow/status/aedot/containers/release.yaml?style=for-the-badge&label=Release)

</div>

Welcome to my container images! If you are looking for a container, start by [browsing the GitHub Packages page for this repository's packages](https://github.com/aedot?tab=packages&repo_name=containers). Please also check out the inspiration repo from [home-operations](https://github.com/home-operations/containers).
...
| Container | Immutable |
|-----------------------|----|
| `ghcr.io/aedot/home-assistant:rolling` | ❌ |
| `ghcr.io/aedot/home-assistant:2025.5.1` | ❌ |
| `ghcr.io/aedot/home-assistant:rolling@sha256:8053...` | ✅ |
| `ghcr.io/aedot/home-assistant:2025.5.1@sha256:8053...` | ✅ |
...
services:
  home-assistant:
    image: ghcr.io/aedot/home-assistant:2025.5.1
...
```sh
gh attestation verify --repo aedot/containers oci://ghcr.io/aedot/${App}:${TAG}
```
...
cosign verify-attestation --new-bundle-format --type slsaprovenance1 \
    ...
    --certificate-identity-regexp "^https://github.com/aedot/containers/.github/workflows/app-builder.yaml@refs/heads/main" \
    ghcr.io/aedot/${APP}:${TAG}
```
